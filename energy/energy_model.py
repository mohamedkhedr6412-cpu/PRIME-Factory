...
def calculate_financial_with_evidence(
    ...
    base_costs = calculate_financial_and_esg_impact(
        total_energy_kwh, downtime_minutes, good_units, avg_pf
    )
    ...
    # Maintenance costs
    maintenance_cost = maintenance_events * config.COST_PARAMETERS.get("maintenance_base_cost", 1000.0)
    ...
    return {
        **base_costs,
        ...
        "total_cost_with_maintenance_usd": round(base_costs["total_operational_cost_usd"] + maintenance_cost, 2)
    }
